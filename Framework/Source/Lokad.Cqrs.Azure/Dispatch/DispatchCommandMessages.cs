...
namespace Lokad.Cqrs.Dispatch
{
	...
	/// </summary>
	public sealed class DispatchCommandMessages : IMessageDispatcher
	{
		...
		public DispatchCommandMessages(ILifetimeScope container, MessageDirectory messageDirectory)
		{
