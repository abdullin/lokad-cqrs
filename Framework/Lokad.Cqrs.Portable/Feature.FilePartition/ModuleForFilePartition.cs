...
{
    public sealed class ModuleForFilePartition : BuildSyntaxHelper, IModule
    {
        ...
        public ModuleForFilePartition WhereFilter(Action<MessageDirectoryFilter> filter)
        {
            filter(_filter);
            return this;
        }
        ...
        public ModuleForFilePartition(string[] memoryQueues)
        {
